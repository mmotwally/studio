...
import { FormItem, FormControl, FormLabel as RHFFormLabel } from '@/components/ui/form';
  ...
  const handleFormulaSelect = (partIndex: number, formulaField: 'widthFormula' | 'heightFormula' | 'quantityFormula', selectedFormulaValue: string) => {
    setCurrentTemplate(prev => {
        ...
        if (newTemplate.parts && newTemplate.parts[partIndex]) {
            ...
            if (formulaInfo) {
                (newTemplate.parts[partIndex] as any)[`${formulaField}Key`] = formulaInfo.key;
            } else {
      ...
      return (
        <div className="flex items-end gap-2">
          <div className="flex-grow">
            ...
            <Input id={`part_${partIndex}_${formulaField}`} value={currentFormulaValue} onChange={(e) => handleTemplateInputChange(e, `parts.${partIndex}.${formulaField}`)} placeholder={placeholder} className="text-sm" />
          </div>
