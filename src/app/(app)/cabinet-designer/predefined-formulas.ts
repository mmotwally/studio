...
export const PREDEFINED_FORMULAS = [
    ...
    { key: "WIDTH_SHELF", name: "Shelf Width", description: "Width of a shelf, accounting for side panel thickness.", partType: "Fixed Shelf", context: ["Base", "Wall", "General"], dimension: "Width", formula: "W - 2 * PT" },
    { key: "DEPTH_SHELF", name: "Shelf Depth", description: "Depth of a shelf, accounting for back panel offset.", partType: "Fixed Shelf", context: ["Base", "Wall", "General"], dimension: "Height", formula: "D - BPO" },
