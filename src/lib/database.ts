...
async function _seedInitialData(db: Database<sqlite3.Database, sqlite3.Statement>) {
  ...
  const permissionsData = [
    // Settings
    { id: crypto.randomUUID(), name: 'Manage General Settings', description: 'Can manage categories, locations, suppliers, etc.', group: 'Settings' },
    ...
    { id: crypto.randomUUID(), name: 'Print Stock Movement Reports', description: 'Can generate and print/download a PDF stock movement report.', group: 'Inventory' },
    // Requisitions
    { id: crypto.randomUUID(), name: 'View Requisitions', description: 'Can view all material requisitions.', group: 'Requisitions' },
    ...
    { id: crypto.randomUUID(), name: 'Submit Purchase Orders for Approval', description: 'Can move a PO from DRAFT to PENDING_APPROVAL status.', group: 'Purchase Orders' },
    ...
    { id: crypto.randomUUID(), name: 'Mark Purchase Order as Ordered', description: 'Can move an APPROVED PO to ORDERED status.', group: 'Purchase Orders' },
